#modified from geom_boxplot code https://github.com/tidyverse/ggplot2/blob/master/R/stat-boxplot.r
#one section from qqplotr code https://github.com/aloy/qqplotr
...
#' @usage NULL
#' @export
StatQqboxplot <- ggproto("StatQqboxplot", Stat,
                       required_aes = c("y"),
